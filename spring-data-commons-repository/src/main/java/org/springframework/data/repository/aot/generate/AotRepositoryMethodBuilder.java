...
class AotRepositoryMethodBuilder {
	...
	/**
	 * Register a {@link MethodContributor.RepositoryMethodContribution} for the repository interface that can contribute
	 * a query method implementation block.
	 *
	 * @param contribution
	 * @return
	 */
	 ...
	 * {@link MethodContributor.RepositoryMethodContribution}.
	 *
	 * @param customizer
	 * @return
	 */
	...
	/**
	 * Builds an AOT repository method if {@link MethodContributor.RepositoryMethodContribution} can contribute a method.
	 *
