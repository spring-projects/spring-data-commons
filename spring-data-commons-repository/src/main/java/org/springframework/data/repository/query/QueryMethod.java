...
public class QueryMethod {
	...
	public boolean isScrollQuery() {
		return ClassUtils.isAssignable(Window.class, unwrappedReturnType);
	}
	...
	public boolean isSliceQuery() {
		return !isPageQuery() && ClassUtils.isAssignable(Slice.class, unwrappedReturnType);
	}
	...
	public final boolean isPageQuery() {
		return ClassUtils.isAssignable(Page.class, unwrappedReturnType);
	}
