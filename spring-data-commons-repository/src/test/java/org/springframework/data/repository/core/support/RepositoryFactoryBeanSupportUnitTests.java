...
class RepositoryFactoryBeanSupportUnitTests {
	...
	void reportsMappingContextUnavailableForPersistentEntityLookup() {
		...
		var bean = new RepositoryFactoryBeanSupport<SampleRepository, Object, Long>(SampleRepository.class) {
	...
	interface SampleWithQuerydslRepository extends Repository<Object, Long> {}
}
