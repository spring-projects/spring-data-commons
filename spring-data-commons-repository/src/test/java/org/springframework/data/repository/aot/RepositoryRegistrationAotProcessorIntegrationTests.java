...
import org.springframework.data.repository.aot.sample.ConfigWithCustomImplementation;
import org.springframework.data.repository.aot.sample.ConfigWithCustomRepositoryBaseClass;
import org.springframework.data.repository.aot.sample.ConfigWithFragments;
import org.springframework.data.repository.aot.sample.ConfigWithQueryMethods;
import org.springframework.data.repository.aot.sample.ConfigWithQueryMethods.ProjectionInterface;
import org.springframework.data.repository.aot.sample.ConfigWithQuerydslPredicateExecutor;
import org.springframework.data.repository.aot.sample.ConfigWithQuerydslPredicateExecutor.Person;
import org.springframework.data.repository.aot.sample.ConfigWithSimpleCrudRepository;
import org.springframework.data.repository.aot.sample.ConfigWithTransactionManagerPresent;
import org.springframework.data.repository.aot.sample.ConfigWithTransactionManagerPresentAndAtComponentAnnotatedRepository;
import org.springframework.data.repository.aot.sample.QConfigWithQuerydslPredicateExecutor_Person;
import org.springframework.data.repository.aot.sample.ReactiveConfig;
