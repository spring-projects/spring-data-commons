...
class AbstractRepositoryMetadataUnitTests {
	...
	Stream<DynamicTest> detectsReturnTypesForStreamableAggregates() throws Exception {
		...
		var methods = Stream.of(Map.entry("findBy", StreamableAggregate.class),
				Map.entry("findSubTypeBy", StreamableAggregateSubType.class), Map.entry("findAllBy", StreamableAggregate.class),
