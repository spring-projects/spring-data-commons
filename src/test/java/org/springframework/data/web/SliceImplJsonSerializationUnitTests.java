...
/**
 * Unit tests for SliceImpl serialization.
 *
 * @author Adrien Caubel
 */
class SliceImplJsonSerializationUnitTests {
	...
	@Test // GH-3516
	void doesNotRenderTotalsForSlice() {
	...
	@Test // GH-3516
	void serializesCustomSliceAsSlicedModel() {
	...
	@Test // GH-3516
	void stillSerializesPageImplAsPagedModel() {
	...
	private static String write(PageSerializationMode mode, Slice<?> slice) {
