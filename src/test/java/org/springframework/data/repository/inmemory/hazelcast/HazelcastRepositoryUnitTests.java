 ...
 */
public class HazelcastRepositoryUnitTests extends GenericInMemoryRepositoryUnitTests {

	@Override
	protected InMemoryRepositoryFactory<Person, String> getRepositoryFactory() {
		return new HazelcastBackedRepositoryFactory<Person, String>(new HazelcastTemplate(
				HazelcastUtils.preconfiguredHazelcastAdapter()));
	}

	@Test
	@Ignore("TODO: pagination does not properly work")
	@Override
