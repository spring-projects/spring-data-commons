 ...
 *
 * This class is a copy of the class of same name from the spring framework, with the only change to not always exclude
 * the packages listed in {@link #DEFAULT_EXCLUDED_PACKAGES}.
 *
 * @author Rob Harrop
