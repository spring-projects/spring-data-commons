...
class FactoryMethodUnitTests {
	...
	void shouldCreateInstanceThroughFactoryMethod() {
		...
		PersistentEntity<FactoryPerson, ?> entity = new BasicPersistentEntity<>(
				ClassTypeInformation.from(FactoryPerson.class));

		FactoryPerson result = instantiators.getInstantiatorFor(entity)
				.createInstance(entity, new ParameterValueProvider() {
