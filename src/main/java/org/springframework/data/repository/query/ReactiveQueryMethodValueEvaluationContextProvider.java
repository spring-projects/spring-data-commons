...
/**
 * Provides a way to access a centrally defined potentially shared {@link ValueEvaluationContext} by considering
 * {@link org.springframework.data.spel.spi.ReactiveEvaluationContextExtension}.
 *
 * @author Mark Paluch
 * @since 3.3
 */
public interface ReactiveQueryMethodValueEvaluationContextProvider extends QueryMethodValueEvaluationContextProvider {
	 ...
	 *         {@link ExpressionDependencies}.
	 */
	Mono<ValueEvaluationContext> getEvaluationContextLater(Object[] parameterValues, ExpressionDependencies dependencies);
}
