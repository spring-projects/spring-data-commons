...
public class InMemoryRepositoryFactory<T, ID extends Serializable> extends RepositoryFactorySupport {
	...
	public InMemoryRepositoryFactory(InMemoryOperations inMemoryOpereations) {
		this.inMemoryOperations = inMemoryOpereations;
	}
	...
	protected Object getTargetRepository(RepositoryMetadata metadata) {
		...
		return new BasicInMemoryRepository<T, ID>(entityInformation, inMemoryOperations);
	}
	...
	protected QueryLookupStrategy getQueryLookupStrategy(Key key, EvaluationContextProvider evaluationContextProvider) {
		return new InMemoryQueryLookupStrategy<T, ID>(key, evaluationContextProvider, inMemoryOperations);
	}

	static class InMemoryQueryLookupStrategy<T, ID extends Serializable> implements QueryLookupStrategy {
