...
1. If there is a single constructor, it will be used.
2. If there are multiple constructors and exactly one is annotated with `@PersistenceConstructor`, it will be used.
3. If there's a no-argument constructor, it will be used.
