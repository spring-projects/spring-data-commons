...
Those Modules are imported once xref:repositories/core-extensions.adoc#core.web[web support] is enabled and a `com.fasterxml.jackson.databind.ObjectMapper` is available on the classpath.
