...
public interface TypeInformation<S> {
	 ...
	 * {@link Collection} and {@link java.lang.reflect.Array} or anything implementing {@link Iterable}. If this returns
	 * {@literal true} you can expect {@link #getComponentType()} to return a non-{@literal null} value.
	 *
	 * @return
	 */
	...
	/**
	 * Returns the component type for {@link Collection}s, the key type for {@link Map}s or the single generic type if
	 * available. Throws {@link IllegalStateException} if the component value type cannot be resolved.
	 *
	 * @return
	 ...
	 *
	 * @return
	 * @throws IllegalStateException if the map value type cannot be resolved, usually due to the current {@link Map} type
	 *           being a raw one.
	 * @since 2.0
	 */
	 ...
	 *
	 * @return
	 * @throws IllegalArgumentException if the current type is a raw {@link Map} or {@link Collection} and no value or
	 *           component type is available.
	 * @since 2.0
	 */
